...
try {
    ...
    switch ($format) {
        case 'csv':
            // Generar CSV
            $filename = "fichajes_anteriores_" . $username . ".csv";
        ...
        case 'excel':
            // Generar Excel
            $filename = "fichajes_anteriores_" . $username . ".xls";
        ...
        case 'pdf':
            // Generar PDF
            $filename = "fichajes_anteriores_" . $username . ".pdf";
            $dompdf = new Dompdf();
            ...
            <h1>Fichajes Anteriores de ' . htmlspecialchars($user_name) . '</h1>
            <table>
                <thead>
                    <tr>
